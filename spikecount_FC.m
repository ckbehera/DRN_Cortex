...
% fname = 'C:\Users\ck1be\OneDrive - Ulster University\Documents\all data\Desktop\current_works\oxford works\Jose contrb\FINAL COUNTDOWN\IFR\ruairi original\Mouse number 0.csv';
% NUM = xlsread(fname);
...
% fname = ['C:\Users\ck1be\OneDrive - Ulster University\Documents\all data\Desktop\current_works\' ...
...
for it = 1:3
    for ich = 1:Nchann
        ...
        % fnm=sprintf('%s_Neuron_id_%s.fig',stat_names{it},channlab);
        %savefig(fnm);
        close all;
    end
end
